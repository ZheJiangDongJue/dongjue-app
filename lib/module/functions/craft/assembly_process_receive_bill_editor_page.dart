...
class AssemblyProcessReceiveBillEditorPage extends FormPageStatefulWidget {
  AssemblyProcessReceiveBillEditorPage({super.key});

  Map? preSetData;

  @override
  State<AssemblyProcessReceiveBillEditorPage> createState() => _AssemblyProcessReceiveBillEditorPageState();
}

class _AssemblyProcessReceiveBillEditorPageState extends State<AssemblyProcessReceiveBillEditorPage> {
  ...
  void initState() {
    super.initState();
    formModel = FormModel(tableName: "AssemblyProcessReceiveDocument");
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Consumer<FormModel>(builder: (context, model, child) {
                        var status = DocumentStatus.fromValue(model.data["Status"] ?? 0);
                        return Container(
